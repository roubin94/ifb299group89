...
public $booking_end_time            = "18:00"; 			// The time of the last slot in 24 hour H:M format  
...
public $cost_per_slot				= 25.00;			// The cost per slot
...
function booking_form() {
	...
	echo "
	<div id='outer_booking'><h2>Available Lessons</h2>

	<p>
	The following Lesson Times are available on <span> " . $this->day . "-" . $this->month . "-" . $this->year . "</span>
	</p>
		...
		<div id='selected_slots'></div>		
			...
			<div id='basket_details'>
				...
				<form method='post' action='/book_slots.php'>
					...
					<div>
						<input type='submit' class='classname' id='select-submit' value='Make Booking'>
					</div>
				</form>
